...
import { GlobeConfig, ColorScheme, GlobeApp, GlobeAppContext, BRIGHT_THEME } from '../domain';
...
export default function Globe() {
  ...
  useEffect(() => {
    ...
    app = GlobeApp.create(container, canvas, new GlobeConfig(), ColorScheme.bright(), BRIGHT_THEME, undefined, {
      onHover(hit) {
  ...
  return (
    <div className="globe-container" ref={containerRef}>
      ...
      <button className="source_btn" onClick={() => window.open(BRIGHT_THEME.sourceUrl, '_blank')}>
        <svg width="25px" viewBox="0 0 24 24" fill="none" stroke={BRIGHT_THEME.buttonStroke}>
